...
class LocationSimulation : Simulation() {
    ...
    private val scn = scenario("slhc.Location")
        .exec(http("request_1")
            .get("/api/locations?locationId=locationId=boxPicker/SWISSLOG-NA-TC/PHARMACY-NORTH/BP01"))
        .pause(1)
